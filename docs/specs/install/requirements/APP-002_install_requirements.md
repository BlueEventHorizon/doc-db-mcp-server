...
| ID              | 内容                                                                                                                                                                                                                                                                                                       | 期限         |
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| ~~INST-TBD-01~~ | ~~tap オーナー名~~ → **確定: `BlueEventHorizon`**（実リポジトリ URL `github.com/BlueEventHorizon/doc-db-mcp-server` に合わせる。tap 名は `blueeventhorizon/doc-db`）。go.mod の module path は `github.com/k2moons/doc-db-mcp-server` だが、これは Go module の internal namespace であり tap 命名とは独立 | **確定**     |
